...
declare global {
  var __safeAreaIme: {
    ...
    closeKeyboard(callback: NativeKeyboardNotificationsListener): void;
...
export const layout = {
  ...
  closeKeyboard(callback: NativeKeyboardNotificationsListener) {
    global.__safeAreaIme.closeKeyboard(callback);
  },
